...
public class ApiKeyInitializer implements ServletContextListener {
  ...
  static final String ATTRIBUTE_ACCESS_KEY = "AIzaSyDQf0LdIIzScFF7TpcEXHE3N-G2ks2a97A";
  ...
  public void contextInitialized(ServletContextEvent event) {
    ...
    //    "WEB-INF/classes");
    //String key = getKey();
    event.getServletContext().setAttribute(ATTRIBUTE_ACCESS_KEY, "AIzaSyDQf0LdIIzScFF7TpcEXHE3N-G2ks2a97A");
  }
